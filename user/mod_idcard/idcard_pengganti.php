    ...
    <div class="col-12 col-sm-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4>FORM PEMBUATAN ID CARD BARU PENGGANTI KARENA HILANG</h4>
            </div>
            <div class="card-body">
                            <form id="form-idcard_pengganti">
                                ...
                                <div class="form-group">
                                    <center>
                                    	<button id="btnlanjut" type="submit" class="btn btn-primary btn-lg mt-2">Lanjut</button>
                                    </center>
                                </div>
                            </form>
    </div>
...
<script>
     $('#form-idcard_pengganti').submit(function(e) {
      e.preventDefault();
      $.ajax({
        type: 'POST',
        url: 'user/mod_idcard/crud_idcard.php?pg=idcard_pengganti',
        data: $(this).serialize(),
        success: function(data) {
          if (data == "ok") {
              ...
              setTimeout(function() {
                window.location.replace('?pg=upload_idcard_pengganti');
              }, 500);
          }
          else {
            iziToast.error({
