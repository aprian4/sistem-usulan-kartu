    ...
    <div class="col-12 col-sm-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4>FORM PEMBUATAN KARTU SUAMI BARU</h4>
            </div>
            <div class="card-body">
                            <form id="form-karsu_baru">
...
<script>
     $('#form-karsu_baru').submit(function(e) {
      e.preventDefault();
      $.ajax({
        type: 'POST',
        url: 'user/mod_karsu/crud_karsu.php?pg=karsu_baru',
        data: $(this).serialize(),
        success: function(data) {
          if (data == "ok") {
              ...
              setTimeout(function() {
                window.location.replace('?pg=upload_karsu_baru');
              }, 500);
          }
          else {
            iziToast.error({
