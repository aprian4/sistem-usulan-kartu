                ...
                <table class="table table-striped table-sm" id="table-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 60%">
                                <div class="form-group row mb-2">
                                    <label class="col-sm-12 col-md-12">Scan Lampiran X<b> (Max. Ukuran File 2MB dan Format File .jpg)</b></label>
                                </div>
                            </td>
                            <?php
                        ...
                        <tr>
                            ...
                            <td style="width: 60%">
                                <div class="form-group row mb-2">
                                    <label class="col-sm-12 col-md-12">Scan Lampiran XI<b> (Max. Ukuran File 2MB dan Format File .jpg)</b></label>
                                </div>
                            </td>
                            <?php
                        ...
                        <tr>
                            ...
                            <td style="width: 60%">
                                <div class="form-group row mb-2">
                                    <label class="col-sm-12 col-md-12">Scan Surat Kehilangan dari Kepolisian <b> (Max. Ukuran File 2MB dan Format File .jpg)</b</label>
                                </div>
                            </td>
                            <?php
                    ...
                    <form id="form-kirim">
                                ...
                                <div class="form-group">
                                    ...
                                    onclick="if(!this.form.checkbox.checked){alert('Silahkan klik checkbox sebelum menekan tombol submit!');return false}">KIRIM USULAN</button></center>
                                </div>
                            </form>
    </div>
</div>
